...
Validation: 1,470 tests passed, 23 skipped; TypeScript, targeted ESLint, translation completeness, copy rules, and diff whitespace checks passed. The permanent change and completed locale translations were deployed on September 14 in revision `markaestro-build-2026-09-14-003`. The isolated production invite/upload smoke test passed; see `release-2026-09-14.md`. The earlier customer data repair remains in place.
