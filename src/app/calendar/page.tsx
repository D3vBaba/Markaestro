  ...
  if (item.kind === "post") {
    ...
    return (
      <button
        ...
        className="w-full text-left rounded-lg overflow-hidden transition-all duration-150 hover:brightness-95 active:scale-[0.98] cursor-grab active:cursor-grabbing"
        ...
        <div className="px-2 py-1.5 flex gap-2">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-1.5 min-w-0">
              ...
              <span className="text-[11px] font-semibold leading-tight truncate" style={{ color: accent }}>
  ...
  return (
    ...
    >
      <div className="px-2 py-1.5">
        <div className="flex items-center gap-1.5 min-w-0">
          <span className="text-[11px] font-semibold leading-tight" style={{ color: adAccent }}>Ad</span>
          <span className="text-[11px] text-foreground/55 truncate leading-tight flex-1 min-w-0">{item.ad.name}</span>
        </div>
      </div>
    </button>
  );
