  ...
  return (
    ...
    >
      <div className="mx-auto max-w-md text-center">
        ...
        <p
          className="mt-2 font-mono text-[80px] font-semibold leading-none mk-figure text-mk-accent"
        >
          404
        </p>
        <h1
          className="mt-5 text-[26px] sm:text-[30px] font-semibold leading-[1.1] text-foreground"
        >
          Page Not Found
        </h1>
        <p
        ...
        <div
          className="mt-12 flex justify-center gap-6 text-[11.5px] text-muted-foreground"
        >
          {[
