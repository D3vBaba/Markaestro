...
const channels = [
  ...
  },
  {
    ...
    category: "Social",
    color: "#000000",
    description: "Reach Gen Z and beyond on the fastest-growing short-form platform. Markaestro stages photos and videos inside the app for final review and manual posting.",
    capabilities: [
      "Video and photo drafts staged in Markaestro",
      "Manual review before posting",
      "Scheduled handoff into Markaestro drafts",
      "No provider-side delivery delay",
