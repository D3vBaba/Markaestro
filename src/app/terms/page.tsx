    ...
    <MarketingLayout>
      ...
      >
        ...
        <section>
          ...
          <div className="mt-3 space-y-2">
            <p>You retain responsibility for the legality, accuracy, and use of any data or content you submit to Markaestro, including contact lists, brand assets, uploaded media, and messages sent through the Services.</p>
            <ul className="list-disc space-y-1 pl-6">
        ...
        <section>
          <h2 className="text-[17px] font-semibold text-foreground tracking-[-0.01em]">8. Uploads and Public Content</h2>
          <p className="mt-3">
            Files uploaded through Markaestro may be stored using publicly reachable cloud URLs so they can be used in social posts. You must not upload any file or content unless you are authorized to make it available in that way and hold all required rights. You acknowledge that content published through third-party platforms may become public and subject to those platforms&apos; terms and visibility settings.
          </p>
        </section>

        <section>
          <h2 className="text-[17px] font-semibold text-foreground tracking-[-0.01em]">9. Intellectual Property and Licenses</h2>
          <p className="mt-3">
        ...
        <section>
          <h2 className="text-[17px] font-semibold text-foreground tracking-[-0.01em]">10. Feedback</h2>
          <p className="mt-3">
        ...
        <section>
          <h2 className="text-[17px] font-semibold text-foreground tracking-[-0.01em]">11. Privacy</h2>
          <p className="mt-3">
        ...
        <section>
          <h2 className="text-[17px] font-semibold text-foreground tracking-[-0.01em]">12. Service Changes, Beta Features, and Availability</h2>
          <p className="mt-3">
        ...
        <section>
          <h2 className="text-[17px] font-semibold text-foreground tracking-[-0.01em]">13. Suspension and Termination</h2>
          <p className="mt-3">
        ...
        <section>
          <h2 className="text-[17px] font-semibold text-foreground tracking-[-0.01em]">14. Disclaimers</h2>
          <p className="mt-3">
        ...
        <section>
          <h2 className="text-[17px] font-semibold text-foreground tracking-[-0.01em]">15. Limitation of Liability</h2>
          <p className="mt-3">
        ...
        <section>
          <h2 className="text-[17px] font-semibold text-foreground tracking-[-0.01em]">16. Indemnification</h2>
          <p className="mt-3">
        ...
        <section>
          <h2 className="text-[17px] font-semibold text-foreground tracking-[-0.01em]">17. Governing Law</h2>
          <p className="mt-3">
        ...
        <section>
          <h2 className="text-[17px] font-semibold text-foreground tracking-[-0.01em]">18. Changes to These Terms</h2>
          <p className="mt-3">
        ...
        <section>
          <h2 className="text-[17px] font-semibold text-foreground tracking-[-0.01em]">19. Contact</h2>
          <p className="mt-3">
