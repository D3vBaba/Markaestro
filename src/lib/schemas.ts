...
export const socialChannels = ['facebook', 'instagram', 'tiktok', 'linkedin', 'threads', 'pinterest', 'youtube', 'x'] as const;
...
export const integrationProviders = ['facebook', 'instagram', 'meta', 'tiktok', 'linkedin', 'threads', 'pinterest', 'youtube', 'x'] as const;
export const oauthProviders = ['meta', 'instagram', 'tiktok', 'linkedin', 'threads', 'pinterest', 'youtube', 'x'] as const;
